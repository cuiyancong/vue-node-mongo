! function(n, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports =
    e() : "function" == typeof define && define.amd ? define(e) : (n.__vee_validate_locale__zh_CN =
      n.__vee_validate_locale__zh_CN || {}, n.__vee_validate_locale__zh_CN.js =
      e())
}(this, function() {
  "use strict";
  var n = function(n) {
      var e = 0 === (n = 1024 * Number(n)) ? 0 : Math.floor(Math.log(n) /
        Math.log(1024));
      return 1 * (n / Math.pow(1024, e)).toFixed(2) + " " + ["Byte", "KB",
    ...
    e = {
      ...
      messages: {
        ...
        decimal: function(n, e) {
          void 0 === e && (e = []);
          var t = e[0];
          return void 0 === t && (t = "*"), " " + n + " 必须是数字的而且能够包含" + (
            "*" === t ? "" : t) + " 小数点."
        },
        digits: function(n, e) {
  ...
  return "undefined" != typeof VeeValidate && VeeValidate.Validator.addLocale(
    e), e
});
